  ...
  <div>
    ...
    <div className="big container margin-auto small-padding">
      ...
      <p>
        ...
        vulputate fringilla felis. Aliquam ut arcu et dui feugiat scelerisque eu
        quis diam. Mauris placerat congue dui sit amet blandit. Phasellus
      ...
      <div className="dark-bg small-padding small-margin-top small-border-radius">
        ...
        <p className="white-text-color">
          ...
          Vestibulum at eros nisl. Fusce lobortis erat ante, eu cursus sapien
          molestie at. Pellentesque placerat ante diam, et euismod lacus dictum
          vel. Phasellus vitae sollicitudin mi.
        </p>
        ...
        <div className="panel small-padding white-bg small-margin-top">
          This is a regular panel. Panels have a small shadow and no paddings,
          so you need to add the class to add the desired padding.
        </div>
      </div>
      <div className="panel small-padding white-bg small-margin-top">
        <h3>Form Title</h3>
